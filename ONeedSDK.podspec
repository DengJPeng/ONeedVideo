...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ONeedSDK"
  spec.version      = "1.0"
  spec.summary      = "A short description of ONeedSDK."
  ...
  spec.author             = { "K.L" => "qc_589771531bae428bae7297f2ebdb339b@git.code.tencent.com" }
  # Or just: spec.author    = "K.L"
  # spec.authors            = { "K.L" => "qc_589771531bae428bae7297f2ebdb339b@git.code.tencent.com" }
  # spec.social_media_url   = "https://twitter.com/K.L"
  ...
  spec.source       = { :git => "http://EXAMPLE/ONeedSDK.git", :tag => "#{spec.version}" }
